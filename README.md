...
- [Знакомство с Zustand](#знакомство-с-zustand)
  ...
  - [Инициализировать состояние с помощью реквизитов (props)](#инициализировать-состояние-с-помощью-реквизитов-props)
...
## Инициализировать состояние с помощью реквизитов (props)
