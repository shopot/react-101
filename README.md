...
**Данный раздел описывает фундаментальные основы Redux и базовую реализацию на основе стейт-менеджера Redux, которая встречается в старых проектах до выхода Redux Toolkit (RTK) и RTK Query.**
