...
* По соглашению дополнительная эта информация помещается в поле, называемое `payload`
...
* Если вы хотите разделить логику обработки данных, создайте несколько функций-редюсеров и объедините их в один редюмер более высокого уровня (Root Reducer).
