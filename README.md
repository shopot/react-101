...
которые повторно используют другие компоненты и передают данные с помощью пропсов.
...
На предыдущем шаге вы определили что `Количество ответов` и `Количество правильных ответов` являются переменными
состояния.
...
пользователь дает правильный ответ `Количество правильных ответов` увеличивается на 1.
