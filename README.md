...
- **ReducersMapObject** - Это объект в Redux, который используется для определения набора редьюсеров (reducers) в приложении, может использоваться для создания Root Reducer.
